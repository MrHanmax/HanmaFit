...
const scheduleData: WeekSchedule = {
  monday: {
    morning: [
      ...
      { title: "Strength", time: "8:30 - 9:30", intensity: "High", level: "All levels", type: "Strength", bgColor: "bg-[#FFA500]/10" }
    ],
    afternoon: [
    ...
    evening: [
      { title: "Strength", time: "5:30 - 6:30", intensity: "High", level: "All levels", type: "Strength", bgColor: "bg-[#FFA500]/10" },
      { title: "MMA", time: "7:00 - 8:00", intensity: "High", level: "All levels", type: "MMA", bgColor: "bg-[#457b9d]/10" },
  ...
  wednesday: {
    morning: [
      { title: "Strength", time: "7:00 - 8:00", intensity: "High", level: "All levels", type: "Strength", bgColor: "bg-[#FFA500]/10" },
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="grid grid-cols-7 border-b text-center p-2">
        <div className="font-semibold p-2">7:00 - 10:00<br /><span className="text-xs text-[#FFA500] font-normal">Co-Ed</span></div>
      ...
      <div className="grid grid-cols-7 border-b text-center p-2 bg-pink-50">
        <div className="font-semibold p-2">1:00 - 5:00<br /><span className="text-xs text-[#FFA500] font-normal">Female Only</span></div>
        {dayKeys.map((day, index) => (
          <div key={index} className="p-2">
      ...
      <div className="grid grid-cols-7 text-center p-2">
        <div className="font-semibold p-2">5:00 - 12:00<br /><span className="text-xs text-[#FFA500] font-normal">Co-Ed</span></div>
        {dayKeys.map((day, index) => (
          <div key={index} className="p-2">
